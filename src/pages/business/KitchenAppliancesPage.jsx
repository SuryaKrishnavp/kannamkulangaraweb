...
const KitchenAppliancesPage = () => {
  ...
  return (
    <div className="kitchen-appliances-page" style={{paddingTop:80}}>
      <Navbar
      ...
      <div className="section-header" style={{marginBottom:'1.5rem'}}>
        <h2 style={{fontFamily:'Playfair Display,serif',fontWeight:600,fontSize:'2rem',color:'#1e3a8a',marginBottom:'0.5rem'}}>Kitchen Appliances</h2>
        <p style={{fontSize:'1.1rem',color:'#64748b',margin:0}}>Modern kitchen solutions for every home</p>
      </div>
