...
const EssentialFurniturePage = () => {
  ...
  const furnitureProducts = [
    { name: 'Sofa', icon: FaCouch, color: '#e57373' },
    { name: 'Bed', icon: FaBed, color: '#64b5f6' },
    { name: 'Dining Table', icon: GiTable, color: '#ffd54f' },
    { name: 'Chair', icon: FaChair, color: '#81c784' },
    { name: 'Wardrobe', icon: GiClothes, color: '#ba68c8' },
    { name: 'Bookshelf', image: 'https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=400&q=80' },
    { name: 'TV Stand', image: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80' },
    { name: 'Coffee Table', image: 'https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80' },
    { name: 'Recliner', image: 'https://images.unsplash.com/photo-1519864600265-abb23847ef2c?auto=format&fit=crop&w=400&q=80' },
    { name: 'Dresser', image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=400&q=80' },
  ...
  return (
    <div className="essential-furniture-page" style={{paddingTop:80}}>
      <Navbar
      ...
      <div className="section-header" style={{marginBottom:'1.5rem'}}>
        <h2 style={{fontFamily:'Playfair Display,serif',fontWeight:600,fontSize:'2rem',color:'#1e3a8a',marginBottom:'0.5rem'}}>Essential Furniture</h2>
        <p style={{fontSize:'1.1rem',color:'#64748b',margin:0}}>Comfort and style for every room</p>
      </div>
...
export default EssentialFurniturePage; 