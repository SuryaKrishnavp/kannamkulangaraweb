...
const ElectronicGadgetsPage = () => {
  ...
  const gadgetsProducts = [
    { name: 'Smartphone', image: '/electronicgadgets/smartphones.png' },
    { name: 'Laptop', image: '/electronicgadgets/laptops.png' },
    { name: 'Smart TV', image: '/electronicgadgets/smarttv.jpeg' },
    { name: 'Tablet', image: '/electronicgadgets/tablet.png' },
    { name: 'Smart Watch', image: '/electronicgadgets/smartwatch.png' },
    { name: 'Bluetooth Speaker', image: '/electronicgadgets/bluetoothspeaker.png' },
    { name: 'Headphones', image: '/electronicgadgets/headphone.png' },
    { name: 'Printer', image: '/electronicgadgets/printer.png' },
