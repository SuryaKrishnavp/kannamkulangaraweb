...
const ElectronicGadgetsPage = () => {
  ...
  const gadgetsProducts = [
    { name: 'Smartphone', image: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80' },
    { name: 'Laptop', image: 'https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80' },
    { name: 'Smart TV', image: 'https://images.unsplash.com/photo-1519864600265-abb23847ef2c?auto=format&fit=crop&w=400&q=80' },
    ...
    { name: 'Headphones', image: 'https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80' },
    { name: 'Camera', image: 'https://images.unsplash.com/photo-1519864600265-abb23847ef2c?auto=format&fit=crop&w=400&q=80' },
    { name: 'Printer', image: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=400&q=80' },
    { name: 'Router', image: 'https://images.unsplash.com/photo-1464983953574-0892a716854b?auto=format&fit=crop&w=400&q=80' },
    // ...add up to 50 products
  ];
  const whatsappNumber = '8891966806';
  const [search, setSearch] = useState('');
  const filteredProducts = gadgetsProducts.filter(product =>
    product.name.toLowerCase().includes(search.toLowerCase())
  );

  return (
    <div className="electronic-gadgets-page" style={{paddingTop:80}}>
      <Navbar
        ...
        minimal={true}
      />
      <div style={{maxWidth:600,margin:'1.5rem auto 1rem auto',padding:'0 1rem'}}>
        <input
          type="text"
      ...
      <div className="section-header" style={{marginBottom:'1.5rem'}}>
        <h2 style={{fontFamily:'Playfair Display,serif',fontWeight:600,fontSize:'2rem',color:'#1e3a8a',marginBottom:'0.5rem'}}>Electronic Gadgets</h2>
        <p style={{fontSize:'1.1rem',color:'#64748b',margin:0}}>Latest technology for your modern lifestyle</p>
      </div>
...
export default ElectronicGadgetsPage; 